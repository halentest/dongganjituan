...
<script type="text/javascript">
    ...
    $(document).ready(function(){
         ...
         if(ordersStr == null) {
         	$('#cart-container').append('<p/><div class="alert fade in">哇哦！您的购物车空空如也哦，赶紧去选购吧！<a href="${rc.contextPath}/huopin/goods_list">去选购</a></div>');
         } else {
			 ...
			 $('#button-container').append('<a href="${rc.contextPath}/huopin/goods_list">继续选购</a>&nbsp;&nbsp;');
         ...
         $('#check-out').click(function() {
         	window.location.href = "${rc.contextPath}/huopin/buy_goods_form?orders=" + $.cookie('orders');
         })
    })
</script>
