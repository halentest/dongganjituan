...
public class ExcelReader {
    ...
    public boolean checkColumn() {
        String c0 = sheet.getCell(0, 0).getContents();
        String c1 = sheet.getCell(1, 0).getContents();
        String c2 = sheet.getCell(2, 0).getContents();
        String c3 = sheet.getCell(3, 0).getContents();
